...
type UserRole = 'Chief Instructor' | 'Instructor' | 'Junior Instructor' | 'Craft Instructor' | 'Staff' | 'Student';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={handleRoleChange} defaultValue="Student">
                ...
                <SelectContent>
                  <SelectItem value="Chief Instructor">Chief Instructor</SelectItem>
                  <SelectItem value="Instructor">Instructor</SelectItem>
                  <SelectItem value="Junior Instructor">Junior Instructor</SelectItem>
                  <SelectItem value="Craft Instructor">Craft Instructor</SelectItem>
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={handleDepartmentChange} defaultValue="Computer Science">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                {...register('contactNumber', { 
                  ...
                  pattern: {
                    value: /^[+]?[(]?[0-9]{1,4}[)]?[-\s.]?[0-9]{1,3}[-\s.]?[0-9]{4,6}$/,
