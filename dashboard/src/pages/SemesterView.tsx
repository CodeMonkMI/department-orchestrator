...
import { BookOpen, Users, Calendar, ArrowLeft, MoreHorizontal, Clock, CalendarDays } from 'lucide-react';
...
const semesterDetails: Record<string, SemesterDetail> = {
  'semester-1': { id: 1, name: 'Semester 1', period: 'July - December', courseCount: 4, year: '2023' },
  'semester-2': { id: 2, name: 'Semester 2', period: 'January - June', courseCount: 5, year: '2024' },
  'semester-3': { id: 3, name: 'Semester 3', period: 'July - December', courseCount: 6, year: '2024' },
}
...
const semesterCourses: Record<string, Course[]> = {
  'semester-1': [
    ...
    { 
      ...
      students: 38,
      schedule: [
        { day: 'Tuesday', startTime: '09:00 AM', endTime: '10:30 AM', room: 'Room 203' },
        { day: 'Thursday', startTime: '09:00 AM', endTime: '10:30 AM', room: 'Room 203' }
      ]
    },
    { 
      id: 3, 
      ...
      schedule: [
        ...
        { day: 'Wednesday', startTime: '02:00 PM', endTime: '03:30 PM', room: 'Room 305' }
      ]
    },
    { 
      id: 4, 
      ...
      students: 41,
      schedule: [
        { day: 'Friday', startTime: '11:00 AM', endTime: '01:00 PM', room: 'Room 102' }
      ]
    },
  ],
  'semester-2': [
    { 
      ...
      students: 32,
      schedule: [
        { day: 'Tuesday', startTime: '01:00 PM', endTime: '02:30 PM', room: 'Room 202' },
        { day: 'Thursday', startTime: '01:00 PM', endTime: '02:30 PM', room: 'Room 202' }
      ]
    },
    { 
      id: 6, 
      ...
      students: 29,
      schedule: [
        { day: 'Monday', startTime: '11:00 AM', endTime: '12:30 PM', room: 'Room 304' },
        { day: 'Wednesday', startTime: '11:00 AM', endTime: '12:30 PM', room: 'Room 304' }
      ]
    },
  ],
  'semester-3': [
    ...
    { 
      ...
      students: 27,
      schedule: [
        { day: 'Tuesday', startTime: '11:00 AM', endTime: '12:30 PM', room: 'Room 301' },
        { day: 'Thursday', startTime: '11:00 AM', endTime: '12:30 PM', room: 'Room 301' }
      ]
    },
  ]
};
...
const SemesterView = () => {
  ...
  const currentSemester = semesterId && semesterDetails[semesterId] 
    ? semesterDetails[semesterId] 
    : { id: 0, name: 'Unknown Semester', period: '', courseCount: 0, year: '' };
  
  const courses = semesterId && semesterCourses[semesterId] 
      ...
      <Card className="mb-6">
        <div className="flex flex-wrap gap-4 p-6">
          <div className="flex-1 min-w-[200px] p-4 rounded-lg bg-blue-50 border border-blue-100">
            ...
            <div className="text-lg font-semibold">{currentSemester.period}</div>
          </div>
          ...
          <div className="flex-1 min-w-[200px] p-4 rounded-lg bg-green-50 border border-green-100">
            ...
            <div className="text-lg font-semibold">{currentSemester.courseCount} Courses</div>
          </div>
          ...
          <div className="flex-1 min-w-[200px] p-4 rounded-lg bg-purple-50 border border-purple-100">
            ...
            <div className="text-lg font-semibold">
              {courses.reduce((sum, course) => sum + course.students, 0)} Enrolled
            </div>
          </div>
        </div>
      </Card>
              ...
              <table className="min-w-full border-collapse">
                <thead>
                  <tr>
                    ...
                    {daysOfWeek.map(day => (
                      <th key={day} className="p-3 border bg-slate-50 text-slate-500 text-xs font-medium uppercase">
                        {day}
                      </th>
                    ))}
                  </tr>
                  ...
                  {timeSlots.map((time, index) => (
                    <tr key={time}>
                      ...
                      {daysOfWeek.map(day => {
                        ...
                        return (
                          <td key={`${day}-${time}`} className="border p-1 h-20 align-top">
                            {coursesAtTime.map(course => (
                              ...
                              >
                                ...
                                <div className="flex items-center mt-1 space-x-1">
                                  <Clock size={10} />
                                  <span>
                                    {course.schedule?.find(s => s.day === day)?.startTime} - 
                                    {course.schedule?.find(s => s.day === day)?.endTime}
                                  </span>
                                </div>
